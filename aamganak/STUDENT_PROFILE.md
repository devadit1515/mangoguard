...
> **Page numbers.** Verified against `Crest Report.pdf`, the 24-page export of 13 September
> 2026. Every reference below was checked against that file. Re-check them after any
> re-export, because pagination moves whenever the report does.
