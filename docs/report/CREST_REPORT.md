...
On the bench, after calibrating the threshold to the midpoint of its wet and dry readings, the resistive grid told wet from dry with **92.8% accuracy** over 600 trials (272 true-wet, 285 true-dry, 15 false-wet, 28 false-dry; precision 0.95, recall 0.91). That clears the 90% bar, so **S3 passes.** Figures 7 and 8 show the wet and dry reading distributions and the confusion matrix.
